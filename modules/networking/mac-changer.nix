...
# Also, you can enhance your privacy and security by:
  ...
  systemd.services.macchanger = {
    ...
    serviceConfig = {
      type = "oneshot";
      ExecStart = "sudo ip link set wlp0s20f0u8 down; ${pkgs.macchanger}/bin/macchanger -r wlp0s20f0u8; sudo ip link set wlp0s20f0u8 up";
      ExecStop = "sudo ip link set wlp0s20f0u8 down; ${pkgs.macchanger}/bin/macchanger -p wlp0s20f0u8; sudo ip link set wlp0s20f0u8 up";
