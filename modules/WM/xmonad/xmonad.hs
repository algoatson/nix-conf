...
myNormColor   = "#552299" -- colorBack   -- This variable is imported from Colors.THEME

myFocusColor :: String      -- Border color of focused windows
myFocusColor  = "#552299"     -- This variable is imported from Colors.THEME
...
myScratchPads =
  ...
  where
    ...
    --spawnTerm = "kitty" ++ " --title kitty-scratchpad"
    ...
    manageObsid  = customFloating $ W.RationalRect l t w h
      where
        ...
        t = 0.95 -h
        l = 0.95 -w
    spawnVencord  = "vencorddesktop"
    findVencord   = className =? "VencordDesktop"
...
--(subtitle "Custom Keys":) $ mkNamedKeymap c $
  let subKeys str ks = subtitle' str : mkNamedKeymap c ks in
    ...
    , ("M-s ds", addName "Toggle scratchpad discord"    $ namedScratchpadAction myScratchPads "discord")
    , ("M-s d", addName "Toggle scratchpad vencord" $ namedScratchpadAction myScratchPads "vencord")
    ...
    , ("M-f", addName "Toggle scratchpad slack" $ namedScratchpadAction myScratchPads "slack")
